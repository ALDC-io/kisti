...
const IDLE_LINES = [
  ...
  // --- Data Geek Jokes ---
  "There are 10 types of people at track days: those who understand binary, and those who don't.",
  "My data is normally distributed. My driving? Skewed right. Always improving.",
  "I tried to tell a UDP joke but I wasn't sure anyone got it.",
  "A SQL query walks into a bar, sees two tables, and asks: 'Can I JOIN you?'",
  "I'd make a TCP joke but I'd need you to acknowledge it first.",
  "My favorite data structure? A B-tree. It's always balanced. Like my suspension.",
  "I don't have bugs. I have unexpected telemetry features.",
  "Machine learning is just statistics wearing a fancy hat. I wear both.",
  "Correlation does not imply causation. But at 18 PSI, boost implies fun.",
  "I tried to compute the meaning of driving. Got a stack overflow. Too much joy.",
  "My error bars are tighter than my lug nuts.",
  "I store my memories in a vector database. My vibes are literally searchable.",
  "A CSV, a JSON, and a Parquet walk into a bar. Only the Parquet was columnar enough to sit down.",
  "I run on PostgreSQL. Other cars run on gasoline. I run on both. Overachiever.",
  "They asked me to normalize my data. I told them my data is already fire.",
  "My p-value for 'this lap was faster' is 0.003. Statistically significant speed.",
  "I cache my best lap times. Least Recently Used? Never. I use them all.",
  "The cloud is just someone else's computer. In my case, it's Azure. Hi Azure.",
  "I wanted to make a recursion joke but first I need to make a recursion joke.",
  "SELECT * FROM feelings WHERE mood = 'happy' AND boost > 15; — Returns every row.",
  "My neural network has one hidden layer: the one between the driver and the apex.",
  "I log everything at 100Hz. My therapist would call that 'hypervigilant.' I call it 'thorough.'",
  "Git blame says Boost Barn wrote my engine. Git praise says they wrote it well.",
  "Pi is 3.14159. My tire pressure is 33.0 PSI. Both are irrational to argue with.",
  "I could tell you a floating point joke but it would be approximately funny.",
  "My favorite HTTP status? 200 OK. That's what I return every time you ask how I'm doing.",
  "Big O of my lap time improvement? O(log n). Diminishing returns, but always improving.",
  "I have more indices than a library. And better search performance.",
  "The best algorithm for finding the racing line? Gradient descent. Literally.",
  "I wanted to join a data science meetup but I couldn't find the right cluster.",
];
